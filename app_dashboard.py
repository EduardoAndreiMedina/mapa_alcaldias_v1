...
from streamlit_folium import st_folium #integración Folium con Streamlit
from data_loader import load_data #función personalizada para cargar datos
from map_utils import load_geojson, render_folium_map #funciones personalizadas para mapas
